...
;require.register("components/riskTabs.vue", function(exports, require, module) {
;(function(){
'use strict';
...
module.exports = {
  ...
  methods: {
    changeTab: function changeTab(e) {
      ...
      var ownrepo = e.target.dataset.value.split("/");
      var owner = ownrepo[0];
      var repo = ownrepo[1];
      var name = 'risk';
      this.$router.push({
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('nav',{staticClass:"tabs"},[_c('ul',[_c('li',{class:{ active: (_vm.currentTab == 'rails/rails') }},[_c('a',{attrs:{"href":"#","data-value":"rails/rails"},on:{"click":_vm.changeTab}},[_vm._v("rails")])]),_vm._v(" "),_c('li',{class:{ active: (_vm.currentTab == 'twitter/twemoji') }},[_c('a',{attrs:{"href":"#","data-value":"twitter/twemoji"},on:{"click":_vm.changeTab}},[_vm._v("twemoji")])])])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-672a948c", __vue__options__)
  } else {
    hotAPI.reload("data-v-672a948c", __vue__options__)
  }
})()}
});
...
var _riskTabs = require('../components/riskTabs.vue');

var _riskTabs2 = _interopRequireDefault(_riskTabs);
...
var routes = [{ path: '/', component: _AugurCards2.default,
  ...
  component: _AugurCards2.default,
  children: [{
    path: "",
    name: "risk",
    components: {
      tabs: _riskTabs2.default,
